function [tgeom,boundary_operator] = read_2D_stl_mesh(filename,shrink_factor,...
                                        centre_data,show_plot)
%read_2D_stl_mesh Reads the mesh nodes and boundary nodes of a 2D STL file
%   ...
...
disp(['Reading mesh from: "' filename '.stl"'])
geom = stlread([filename,'.stl']);
nodes = geom.Points(:, 1:2);
tris = geom.ConnectivityList;
